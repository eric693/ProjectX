          ...
          <div className="bg-slate-800 rounded-xl p-8 border border-blue-500/20">
            ...
            <div className="space-y-3 mb-6">
              {mockQuestions[currentQuestion].options.map((option, idx) => (
                <button
                  key={idx}
                  className="w-full text-left px-6 py-4 bg-slate-700 hover:bg-slate-600 text-white rounded-lg border border-slate-600 hover:border-blue-500 transition"
                >
            ...
            <div className="flex gap-4">
              ...
              <button className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-lg font-semibold hover:shadow-lg transition">
                下一題
              </button>
            </div>
          </div>
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex gap-2 border-b border-slate-700">
          {['文字筆記', '圖片分析', '影片摘要', '手寫辨識'].map((tab, idx) => (
            <button
              key={idx}
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-slate-800 rounded-xl p-6 border border-purple-500/20">
            ...
            <div className="flex gap-3 mt-4">
              <button className="flex-1 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg font-semibold hover:shadow-lg transition">
            ...
            <div className="space-y-4">
              <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
                ...
                <div className="text-sm text-gray-300">
                  本筆記討論了 React Hooks 的核心概念，包括 useState 和 useEffect 的使用方式...
                </div>
              </div>
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-500/20">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="bg-slate-700/50 rounded-lg p-4 hover:bg-slate-700 transition cursor-pointer">
                <div className="flex justify-between items-start mb-2">
                  <h4 className="font-semibold text-white">React Hooks 筆記</h4>
                  <Brain className="w-5 h-5 text-purple-400" />
                </div>
                <p className="text-sm text-gray-400 mb-3">探討 useState 和 useEffect 的使用時機...</p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 bg-slate-800 rounded-xl p-6 border border-green-500/20">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="flex gap-2">
                ...
                <button className="px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-lg hover:shadow-lg transition text-sm">
                  AI 分析
                </button>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-slate-800 rounded-xl p-5 border border-green-500/20">
              ...
              <div className="space-y-2">
                <button className="w-full py-2 bg-slate-700 text-white rounded-lg hover:bg-slate-600 transition text-sm">
                  改善文法
                </button>
                <button className="w-full py-2 bg-slate-700 text-white rounded-lg hover:bg-slate-600 transition text-sm">
                  精簡內容
      ...
      <div className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-slate-800 rounded-xl p-6 border border-orange-500/20">
            ...
            <div className="flex gap-3 mt-4">
              <button className="flex-1 py-3 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-lg font-semibold hover:shadow-lg transition">
          ...
          <div className="space-y-4">
            <div className="bg-slate-800 rounded-xl p-6 border border-orange-500/20">
              ...
              <div className="bg-slate-900 rounded-lg p-4 font-mono text-sm text-green-400">
                <div>{'>'} Hello World</div>
                <div className="text-gray-500 mt-2">執行完成 (執行時間: 0.12s)</div>
              </div>
            </div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
                ...
                <div className="mt-4 space-y-2">
                  <div>
                    <div className="flex justify-between text-xs mb-1">
                      <span className="text-gray-300">發音</span>
                      <span className="text-yellow-400">85%</span>
                    </div>
                    <div className="w-full bg-slate-700 rounded-full h-1.5">
                      <div className="bg-yellow-500 h-1.5 rounded-full" style={{ width: '85%' }} />
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between text-xs mb-1">
                      <span className="text-gray-300">流暢度</span>
                  ...
                  <div>
                    <div className="flex justify-between text-xs mb-1">
                      <span className="text-gray-300">準確性</span>
                      <span className="text-yellow-400">92%</span>
                    </div>
                    <div className="w-full bg-slate-700 rounded-full h-1.5">
                      <div className="bg-yellow-500 h-1.5 rounded-full" style={{ width: '92%' }} />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-slate-800 rounded-xl p-5 border border-yellow-500/20">
              <h4 className="font-bold text-white mb-3">學習進度</h4>
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-300">單字量</span>
                  <span className="text-white font-bold">2,450</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-300">對話時數</span>
                  <span className="text-white font-bold">12.5 hrs</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-300">連續天數</span>
                  <span className="text-white font-bold">15 天</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800 rounded-xl p-5 border border-yellow-500/20">
              ...
              <div className="space-y-2">
                {['餐廳點餐', '機場對話', '面試英文', '日常閒聊'].map((scenario) => (
                  <button key={scenario} className="w-full py-2 bg-slate-700 text-white rounded-lg hover:bg-slate-600 transition text-sm text-left px-3">
                    {scenario}
                  </button>
                ))}
              </div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-slate-800 rounded-xl p-6 border border-rose-500/20">
            ...
            <div className="mb-4">
              <label className="block text-gray-300 mb-2">壓力等級 (1-10)</label>
              <input
                type="range"
                min="1"
                max="10"
            ...
            <button className="w-full mt-4 py-3 bg-gradient-to-r from-rose-500 to-pink-500 text-white rounded-lg font-semibold hover:shadow-lg transition">
              儲存記錄
            </button>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-slate-800 rounded-xl p-6 border border-rose-500/20">
              ...
              <div className="space-y-3">
                {['5 分鐘呼吸冥想', '10 分鐘正念練習', '睡前放鬆引導', '壓力釋放練習'].map((practice) => (
                  <button key={practice} className="w-full flex items-center justify-between p-3 bg-slate-700 hover:bg-slate-600 text-white rounded-lg transition">
            ...
            <div className="bg-slate-800 rounded-xl p-6 border border-rose-500/20">
              <h3 className="text-lg font-bold text-white mb-4">本週統計</h3>
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-slate-700/50 rounded-lg p-3 text-center">
                  <div className="text-2xl font-bold text-rose-400">85%</div>
                  <div className="text-xs text-gray-400">平均心情</div>
                </div>
                <div className="bg-slate-700/50 rounded-lg p-3 text-center">
                  <div className="text-2xl font-bold text-blue-400">7.2 hrs</div>
                  <div className="text-xs text-gray-400">平均睡眠</div>
                </div>
                <div className="bg-slate-700/50 rounded-lg p-3 text-center">
                  <div className="text-2xl font-bold text-green-400">5/7</div>
                  <div className="text-xs text-gray-400">冥想天數</div>
                </div>
                <div className="bg-slate-700/50 rounded-lg p-3 text-center">
                  <div className="text-2xl font-bold text-purple-400">4.5</div>
                  <div className="text-xs text-gray-400">壓力指數</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-slate-800 rounded-xl p-6 border border-indigo-500/20">
            ...
            <div className="flex gap-3">
              <button className="flex-1 py-3 bg-gradient-to-r from-indigo-500 to-blue-500 text-white rounded-lg font-semibold hover:shadow-lg transition">
                AI 優化建議
              </button>
              <button className="px-6 py-3 bg-slate-700 text-white rounded-lg hover:bg-slate-600 transition">
                ATS 檢查
          ...
          <div className="space-y-4">
            <div className="bg-slate-800 rounded-xl p-6 border border-indigo-500/20">
              <h3 className="text-lg font-bold text-white mb-4">技能分析</h3>
              <div className="space-y-3">
                <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-3">
                  <div className="font-semibold text-green-300 text-sm mb-2">✅ 擁有技能</div>
                  <div className="flex flex-wrap gap-2">
                    {['React', 'Python', 'SQL', 'Git'].map((skill) => (
                      <span key={skill} className="px-2 py-1 bg-green-500/20 text-green-300 rounded text-xs">
                        {skill}
                      </span>
                    ))}
                  </div>
                ...
                <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-3">
                  <div className="font-semibold text-yellow-300 text-sm mb-2">📚 建議學習</div>
                  <div className="flex flex-wrap gap-2">
                    {['TypeScript', 'Docker', 'AWS', 'GraphQL'].map((skill) => (
                      <span key={skill} className="px-2 py-1 bg-yellow-500/20 text-yellow-300 rounded text-xs">
                        {skill}
                      </span>
                    ))}
                  </div>
          ...
          <div className="md:col-span-2 bg-slate-800 rounded-xl p-6 border border-indigo-500/20">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {[
                { type: '技術面試', icon: Code, color: 'orange' },
                { type: '行為面試', icon: MessageSquare, color: 'blue' },
                { type: '系統設計', icon: Brain, color: 'purple' }
              ].map((interview) => {
                const Icon = interview.icon;
                return (
                  <div key={interview.type} className="bg-slate-700/50 rounded-lg p-6 text-center hover:bg-slate-700 transition cursor-pointer">
                    <div className={`w-16 h-16 bg-${interview.color}-500/20 rounded-full flex items-center justify-center mx-auto mb-3`}>
                      <Icon className={`w-8 h-8 text-${interview.color}-400`} />
                    </div>
                    <h4 className="font-semibold text-white mb-2">{interview.type}</h4>
                    <button className="px-4 py-2 bg-slate-600 hover:bg-slate-500 text-white rounded-lg text-sm transition">
                      開始練習
                    </button>
                  </div>
                );
              ...
              {[
                ...
                <div key={idx}>
                  <div className="flex justify-between text-sm mb-2">
                    ...
                    <span className={`text-${goal.color}-400 font-semibold`}>{goal.progress}%</span>
                  </div>
                  <div className="w-full bg-slate-700 rounded-full h-2">
                    <div 
    ...
    return (
      <div className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-slate-900 border-r border-slate-800 transition-all duration-300 flex flex-col`}>
        ...
        <div className="p-4 border-t border-slate-800 space-y-2">
          <button className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-gray-400 hover:text-white hover:bg-slate-800 transition">
